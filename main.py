...
def jogo_adivinhacao(numero_min, numero_max):
    ...
    resposta_label = tk.Label(input_frame, text="O número em que você está pensando é maior, menor ou igual a: ")
    ...
    chute_button = tk.Button(janela, text="Chutar", command=fazer_chute)
